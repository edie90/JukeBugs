 	...
 	$(function(){
 		$("body").on('click', '.fa.fa-heart-o', function(){
			var state = $(this).attr('class');
				var sendData = {"songId" : $(this).attr('data-songid')}
 ...
 -->                    <section class="panel-body slim-scroll" data-height="720px" data-size="10px">
	...
	<div class="tb_list d_song_list align-center">
		...
		<table border="1" style="width:100%">
			...
			<tbody>
			 <c:forEach var="m" items="${userLikes}">
				<tr >
				...
				<ul class="pagination pagination">
					<li><a href="likes?currentPage=${pagenavi.currentPage - 1}">
					...
					<c:forEach var="counter" begin="${pagenavi.startPageGroup}" end="${pagenavi.endPageGroup}">
						<c:choose>
							<c:when test="${pagenavi.currentPage == counter}">
								<li class="active"><a href="likes?currentPage=${counter}">${counter}</a></li>
							</c:when>
							<c:otherwise>
								<li><a href="likes?currentPage=${counter}">${counter}</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
					<li><a href="likes?currentPage=${pagenavi.currentPage + 1}">

          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle bg clear" data-toggle="dropdown">
              <span class="thumb-sm avatar pull-right m-t-n-sm m-b-n-sm m-l-sm">
              	<c:if test="${sessionScope.loginId ne null}">
                <img src="upload/${sessionScope.userprofileimgurl }" alt="..." style="height: 40px; width: 40px;">
                </c:if>
                <c:if test="${sessionScope.loginId eq null}">
                <img src="upload/noArtist.jpg" alt="..." style="height: 40px; width: 40px;">
                </c:if>
              </span>
              ...
              <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                ...
                <nav class="nav-primary hidden-xs">
                  <ul class="nav bg clearfix">
                    ...
                    <li>
                      <a href="logInfo">
                        <i class="icon-info icon text-info"></i>
                    ...
                    <div class="col-xs-6 col-sm-3">
                          <div class="item">
                            <div class="pos-rlt">
                              ...
                              <a href="#"><img src="resources/images/dog.jpg" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">

...
<body class="">
  <section class="vbox">
				...
				<div class="row">
                  <div class="section_contin">
						...
						<div class="radio-change">
							...
							<input type="radio" name="searchType" value="goSongName" onclick="javascript:raidoGoSongName('${artistName}')" checked="checked">
	...
	<div class="tb_list d_song_list">
		<h4 class="title arr" style="margin-top: 30px;">곡명으로 검색 &nbsp;&nbsp;(${searchBasedOnArtistNameSongListCount })</h4>
           ...
           <input type="hidden" id="currentPage" value="${pagenavi.currentPage}">
            <!-- 페이징 처리 -->
             <ul class="pagination pagination"> <!-- **************  -->
              ...
              <li><a href="goTotalSongNameSongList?currentPage=${pagenavi.currentPage-1}&content=${artistName}"><i class="fa fa-chevron-left"></i></a></li>
              
               <c:forEach var="counter" begin="${pagenavi.startPageGroup}" end="${pagenavi.endPageGroup}">
               
               	<c:choose>
             	  	 	<c:when test="${pagenavi.currentPage == counter}">
             			 	<li class="active"><a href="goTotalSongNameSongList?currentPage=${counter}&content=${artistName}">${counter}</a></li> <!-- **** -->
               	 	</c:when>
              		 	<c:otherwise>
							<li><a href="goTotalSongNameSongList?currentPage=${counter}&content=${artistName}">${counter}</a></li>                        
               	 	</c:otherwise>
               	</c:choose>
               	
               </c:forEach>
               
              <li><a href="goTotalSongNameSongList?currentPage=${pagenavi.currentPage+1}&content=${artistName}"><i class="fa fa-chevron-right"></i></a></li>

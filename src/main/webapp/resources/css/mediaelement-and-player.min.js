...
mejs.version = "2.18.1", mejs.meIndex = 0, mejs.plugins = {
	...
	secondsToTimeCode : function (a, b) {
		...
		lis = [[h, "f"], [g, "s"], [f, "m"], [e, "h"]];
		var j = c;
		for (i = 0, len = lis.length; len > i; i++)
	...
	a.extend(MediaElementPlayer.prototype, {
		...
		buildtracks : function (b, c, d, e) {
			if (0 !== b.tracks.length) {
				...
				"" !== b.options.slidesSelector && (b.slidesContainer = a(b.options.slidesSelector), e.addEventListener("timeupdate", function () {
						b.displaySlides()
					}, !1)),
				e.addEventListener("loadedmetadata", function () {
					b.displayChapters()

                            ...
                            <div class="pos-rlt">
                              <div class="item-overlay opacity r r-2x bg-black">
                                <div class="center text-center m-t-n">
                                  <a href="trackdetail"><i class="fa fa-play-circle i-2x"></i></a> <!-- here -->
                                </div>
                              </div>
                              <a href="test"><img src="${a.albumimgurl}" alt="" class="r r-2x img-full"></a>
                            </div>
                            <div class="padder-v">
                              <a href="test" data-bjax data-target="#bjax-target" data-el="#bjax-el" data-replace="true" class="text-ellipsis">${a.albumtitle}</a>
                              <a href="test" data-bjax data-target="#bjax-target" data-el="#bjax-el" data-replace="true" class="text-ellipsis text-xs text-muted">${a.albumid}</a>
                            </div>
                          </div>
                        </div>
                        </c:forEach>

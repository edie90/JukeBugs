...
<head>  
  ...
  <script type="text/javascript">
	  ...
	  function goTotalArtistSearch(artistid) {
		  alert("aaa");
		  alert(artistid);
			location.href = "goTotalArtistSearch?artistid="+artistid;
		}
  </script>
...
<body class="">
  <section class="vbox">
    ...
    <section>
      <section class="hbox stretch">
        ...
        <section id="content">
          <section class="hbox stretch">
            <section>
              <section class="vbox">
                <section class="scrollable padder-lg w-f-md" id="bjax-target" style="
    				padding-right: 300px;" >
                  <a href="refrashClick()" class="pull-right text-muted m-t-lg" data-toggle="class:fa-spin" ><i class="icon-refresh i-lg  inline" id="refresh"></i></a>
      ...
      <div id="pageList" style="display: ">
	   <div class="list_atist12 d_artist_list">
		<ul>
			<c:forEach var="m" items="${ArtistList }">
			<li>
				<div class="wrap_atist12">
					<a href="javascript:searchLog('web_artist','ARTIST','AR','oasis','104369');melon.link.goArtistDetail('104369');" title="Oasis - 페이지 이동" class="thumb">
						<span class="thumb_frame"></span>
						<img src="upload/${m.artistimgurl }" style="height: 120px; width: 120px" alt=""/>
					</a>
					<div class="atist_info">
						<dl>
							<dt style="font-size: 16px">
								<strong class="none">아티스트명</strong>
								<a href="javascript:searchLog('web_artist','ARTIST','AR','oasis','104369');melon.link.goArtistDetail('104369');" title="Oasis - 페이지 이동" class="ellipsis">${m.artistname }</a>
							</dt>
							<dd class="gubun">
								${m.artistposition }
							</dd>
							<dd class="btn_play">
								...
								<span class="icon_play">탈퇴</span>
								</c:if>
								<c:if test="${m.artistactive eq 'false'}">
								<span class="icon_play">현재 참여중</span>
								</c:if>
							</dd>
							<dd class="gnr">
								<strong class="none">Debut</strong>
								<div class="ellipsis fc_strong">
									<span>${m.artistdebut }</span>
								</div>
							</dd>
							<dd class="gnr">
								<strong class="none">BirthDay</strong>
								<div class="ellipsis fc_strong">
									<span>${m.artistbirthday }</span>
								</div>
							</dd>
							<dd class="wrap_btn">
								<!-- <button onclick="searchLog('web_artist','ARTIST','AR','oasis','104369');" type="button" title="Oasis 팬맺기" class="btn_join_fan" data-artist-no="104369" data-artist-menuId="26020102" name="likeFan_104369"><span class="odd_span">팬</span></button><span class="cnt_fan"><span id="d_fan_cnt_104369" class="cnt_span">0</span></span>
								<input type="hidden" name="artistId" value="104369" /> -->
							</dd>
						</dl>
					</div>
				</div><!-- //class="wrap_atist12" -->
